...
public class ProductoJpaController implements Serializable {
    ...
    public String listarJson() {
        ...
        List<Producto> lista =producto.findProductoEntities();
        for (Producto producto1 : lista) {
             resultado=resultado+"{\"codiProd\":"+producto1.getCodiProd()+","+"\"nombProd\":\""+producto1.getNombProd()+"\""+","+
                     "\"marcProd\":\""+producto1.getMarcProd()+"\""+","+"\"cateProd\":\""+producto1.getCateProd()+"\""+","+
                     "\"formProd\":\""+producto1.getFormProd()+"\","+"\"precProd\":\""+producto1.getPrecProd()+"\""+","+
                     "\"stocProd\":\""+producto1.getStocProd()+"\""+"}"+",";
    ...
    public static void main(String[] args) throws Exception {
        ProductoJpaController producto = new ProductoJpaController();
        String resultado = producto.listarJson();
